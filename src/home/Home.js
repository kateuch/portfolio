    ...
    <div className={style.home} id={"home"}>
      <Card className={style.homeContainer}>
        <div className={style.greatings}>
          <h3>
            EKATERINA UCHAYK<span className={style.letter}>i</span>NA{" "}
          </h3>
          ...
          <div className={style.contactsBlock}>
            <ul className={style.social}>
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/euchaykina/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img className={style.svg} src={link} alt="social" />
                </a>
              </li>
              <li>
                <a
              ...
              <li>
                <a
                  href="https://www.flickr.com/photos/huhtikuu/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img className={style.svg} src={flickr} alt="social" />
                </a>
              </li>
            </ul>
